...
namespace Domain.Services.Jobseeker.Services
{
    public class JobSeekerRepository : IJobSeekerRepository 
    {
       ...
       public async Task<List<Domain.Models.JobPost>> SearchJobAsync(string name)
        ...
        public async Task<JobApplication?> ApplyJobAsync(Guid jobPostId, Guid jobSeekerProfileId)
        {
        ...
        public async Task<List<JobApplication>> GetAppliedJobsAsync(Guid jobSeekerProfileId)
        {
            return await dbContext.JobApplications
            .Include(application => application.AppliedJob)
        ...
        public async Task<List<InterviewSchedule>> GetInterviewSchedulesAsync(Guid jobSeekerProfileId)
        {
