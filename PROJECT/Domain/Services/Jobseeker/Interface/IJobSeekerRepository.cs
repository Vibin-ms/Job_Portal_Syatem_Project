...
namespace Domain.Services.Jobseeker.Interface
{
    public interface IJobSeekerRepository
    {
        ...
        Task<JobApplication?> ApplyJobAsync(Guid jobPostId,Guid jobSeekerProfileId);

        Task<List<JobApplication>> GetAppliedJobsAsync(Guid jobSeekerProfileId);
        ...
        Task<List<InterviewSchedule>> GetInterviewSchedulesAsync(Guid jobSeekerProfileId);
