...
namespace Domain.Services.Jobseeker.Interface
{
    public interface IJobSeekerServices
    {
        ...
        Task<Domain.Models.JobApplication?> ApplyJobAsync(ApplyJobDTO dto);

        Task<List<Domain.Models.JobApplication>> GetAppliedJobsAsync();
        ...
        Task<List<Domain.Models.InterviewSchedule>> GetInterviewSchedulesAsync();
    }
}
